...
def getMembers():
	try:
		request = requests.get('https://www.warwicksu.com/membershipapi/listmembers/c76aa4b2-ae70-43e7-b59f-81d680deb1c5/') #TODO: take key from settings file
...
def validate_format(members_list):
	if not len(members_list[0]['id']) == 7: #TODO: make sure they are also ints -Sorc
		raise ValueError('IDs provided by SU should be strings of 7 digits. Duplicate accounts may be created otherwise. Take that in consideration if overriding.')
	return True
