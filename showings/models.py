...
class Show(models.Model):
	...
	cooldown_period = models.IntegerField(default=0, null=True, blank=True, help_text="In days. Will be filled when saving according to type of show. Input the value manually to override.")
